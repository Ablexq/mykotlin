...
fun main(args: Array<String>) {
    ...
    val newList3 = list.map { it.toDouble() } //将list中的数转换成double型的
    val newList4 = list.map(Int::toDouble) //将list中的数转换成double型的
    ...
    println("打印newList4")
    newList4.forEach(::println) //打印新列表3中的元素

    println("打印newList使用map")
